                ...
                <div class="row g-5">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="section-title position-relative mb-4 pb-2">
                            ...
                            <h2 class="mt-2">The best SEO tools</h2>
                        </div>
                        <p class="mb-4">Search Engine Optimization (SEO) is a critical component of digital marketing. It involves optimizing your website's content and structure to improve its visibility and ranking on search engine results pages (SERPs). To help you with your SEO efforts, there are many SEO tools available that can assist you in optimizing your website and analyzing your competition.</p>
                    </div>
                    <div class="col-lg-6">
            ...
            <div class="container px-lg-5">
                <div class="row align-items-center" style="height: 250px;">
                    <div class="col-12 col-md-6">
                        <h3 class="text-white">Ready to get started with the SEO Tools</h3>
                    </div>
        ...
        <div class="container-xxl py-5">
            <div class="container px-lg-5">
                <div class="section-title position-relative text-center mb-5 pb-2 wow fadeInUp" data-wow-delay="0.1s">
                    <h2 class="mt-2">What Tools We Provide</h2>
                </div>
                <div class="row g-4">
